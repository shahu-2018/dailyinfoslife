    ...
    (v => {
        ...
        (function (e, q, i, w) {
            (() => {
                ...
                var m = 8000318, F = 8000317, xK = 0, vt = 0, _t = 30, Ct = 1, sK = true,
                    hK = U[e.bK](g('eyJhZGJsb2NrIjp7fSwiZXhjbHVkZXMiOiIifQ==')), A = 2,
                    ln = 'Ly9wc2FpdGhhZ29tdGFzdS5uZXQvNDAwLzgwMDAzMTg=', yn = 'cHNhaXRoYWdvbXRhc3UubmV0', Bt = 2,
                    Nt = 1730775777 * e.mr, Tt = 'V2@%YSU2B]G~', Ft = '1yq', At = 'pa459zhbi8x', pn = '598w9v3g',
                    xn = 'y95', sn = 'ljg4hbifvjr', Lt = '_tfcasf', Xt = '_dlmmxhuf', Zt = false, x = e.MK(),
...
})('psaithagomtasu.net', 8000317, document.createElement('script'), _tfcasf)
